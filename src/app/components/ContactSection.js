    ...
    <section id="contact" className="py-20 w-full font-sans bg-transparent">
      ...
      <div className="grid grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
        {socials.map((social, index) => (
          ...
          >
            <div className="relative h-full p-5 md:p-6 rounded-[2rem] border border-white/10 bg-white/[0.03] backdrop-blur-3xl transition-all duration-500 ease-out overflow-hidden shadow-2xl hover:bg-white/[0.07] hover:border-white/20 hover:-translate-y-1.5 active:scale-95">
              ...
              <div className="flex items-start justify-between mb-6 md:mb-8">
                {/* Responsive Color Logic Applied Here */}
                <div className={`w-10 h-10 md:w-12 md:h-12 flex items-center justify-center rounded-xl md:rounded-2xl bg-black/40 border border-white/10 transition-all duration-500 group-hover:border-purple-500/50 group-hover:shadow-[0_0_20px_rgba(168,85,247,0.2)] ${social.colorClasses}`}>
                  <div className="w-5 h-5 md:w-6 md:h-6">
                    {social.icon}
                  </div>
                </div>
                
                <div className="p-2 rounded-lg bg-white/5 border border-white/10 opacity-40 group-hover:opacity-100 group-hover:bg-purple-500/10 group-hover:border-purple-500/20 transition-all duration-500">
              ...
              <div className="relative z-10 space-y-1">
                <h3 className="text-white font-black text-lg md:text-xl tracking-tight leading-none group-hover:text-purple-100 transition-colors">
                  {social.name}
                </h3>
                <p className="text-slate-500 text-[9px] md:text-[10px] font-black uppercase tracking-[0.25em] transition-colors group-hover:text-purple-400/80">
                  {social.label}
                </p>
              </div>
