    ...
    <section className="relative w-full min-h-[70vh] flex items-center justify-center py-16 px-6 overflow-hidden bg-transparent">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto flex flex-col items-center text-center">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter mb-4 leading-[1.1] text-white pt-10">
          I'm <span className="bg-clip-text text-transparent bg-linear-to-r from-primary-400 via-primary-500 to-purple-600 drop-shadow-[0_0_25px_rgba(168,85,247,0.4)] pr-4">
        ...
        <div className="h-8 mb-12">
          <h2 className="text-md md:text-3xl font-medium text-slate-400 tracking-tight">
            {text}
            <span className="ml-1 inline-block w-1 h-6 md:h-8 bg-primary-500 animate-pulse" />
        ...
        >
            ...
            <div className="absolute -inset-1 bg-linear-to-r from-primary-500/10 to-purple-500/10 rounded-[2.5rem] blur-2xl opacity-40" />
        ...
        <div className="relative group">
          <div className="absolute -inset-2 bg-linear-to-r from-primary-500/20 to-purple-600/20 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition duration-700" />
          ...
          >
            ...
            <FileText size={18} className="text-primary-400 group-hover:scale-110 transition-transform duration-300" />
