...
const ProjectSection = () => {
  ...
  // RESTORED: Logic for cycling through projects in the modal
    ...
    <section id="projects" className={`py-20 mt-10 w-full font-sans`}>
      <div className={`space-y-4 mb-12 px-2`}>
        <h2 className={`text-4xl md:text-5xl font-black tracking-tighter text-white uppercase`}>
          Featured <span className={`bg-clip-text text-transparent bg-linear-to-r from-primary-400 via-primary-500 to-purple-600`}>Projects</span>
        </h2>
      ...
      <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6`}>
        {projects.map((project) => (
          ...
          >
            ...
            <div className={`absolute inset-x-8 bottom-0 h-px bg-linear-to-r from-transparent via-primary-500/40 to-transparent 
